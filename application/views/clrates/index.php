            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">Cl Rates</li>
                    </ol>
                </div>
                <h4 class="page-title">Cl Rates</h4>
            </div>
        </div>
    </div>
    <div class="row">
    	<div class="col-sm-12">
    		<form method="post" action="<?= base_url();?>clrate/search" id="searchForm">
    			<div class="row">
    				<div class="col-sm-3">
	    				<div class="form-group">
	    					<label for="field-1" class="control-label">Tariff Name</label>
	    					<select class="form-control" name="search_tariffname" required>
	    						<option></option>
	    			...
	    			<div class="col-sm-2">
	    				<div class="form-group">
	    					...
	    					<input type="text" name="search_prefix" class="form-control" value="<?= $prefix;?>" required>
	    				</div>
	    			</div>
	    			<div class="col-sm-3">
	    				<div class="form-group">
    		...
    		<div class="card-box">
    			<div class="col-12 text-sm-center form-inline mb-3">
    				<div class="form-group mr-2">
    					<?php if($user->cl_status[1] == '1'){?>
                        <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#add-modal"><i class="mdi mdi-plus-circle mr-2" ></i> Add New CL Rate</button>
                        <?php }?>
                    </div>
                    <div class="form-group">
                   			...
                   			foreach($rates as $value){?>
                   				<tr>
		                            ...
		                            <?php }?>
                   					...
                   					<td><?= $value->cost_margin;?></td>
                   					<td><?= $value->cost_margin_conn;?></td>
                   					<td><?= $value->date;?></td>
                   					<td style="">
                   						<?php if($user->cl_status[2] == '1'){?>
	...
	<div class="modal-dialog modal-lg">
	    <div class="modal-content">
	        <div class="modal-header">
	            <h4 class="modal-title">Add Cl Rate</h4>
	            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	        </div>
	        <form method="post" action="<?= base_url();?>clrate/add">
	              <div class="modal-body p-4">
	                  <div class="row">
	                  	...
	                  	<div class="row">
	                      	...
	                      	<div class="col-md-3">
	                          	<div class="form-group">
	                              	<label for="field-1" class="control-label">Cost </label>
	                              	<input class="form-control" type="text" name="cost_margin" data-toggle="input-mask" data-mask-format="09.9999" placeholder="xx.xxxx" value="0.0000">
	                          	</div>
	                      	</div>
	                      	<div class="col-md-3">
	                          	<div class="form-group">
	                              	<label for="field-4" class="control-label">Cost Conn</label>
	                              	<input class="form-control" type="text" name="cost_margin_conn" data-toggle="input-mask" data-mask-format="09.9999" placeholder="xx.xxxx" value="0.0000">
	                          	</div>
	                      	</div>
	                  	</div>
	              </div>
...
<div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; top: 22%;">
	<div class="modal-dialog modal-lg">
	    <div class="modal-content">
	        <div class="modal-header">
	            <h4 class="modal-title">Edit Cl Rate</h4>
	            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	        </div>
	        <form method="post" action="<?= base_url();?>clrate/update">
...
<div id="delete-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; top: 30%;">
	<div class="modal-dialog modal-sm">
	    <div class="modal-content">
	        <div class="modal-header">
	            <h4 class="modal-title">Delete Cl Rate</h4>
	            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	        </div>
            <div class="modal-body p-4">
            	<h4>Are you sure to delete this Cl Rate?</h4>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
