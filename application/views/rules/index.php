    			...
    			<div class="row">
	    				...
	    				<div class="form-group">
	    					...
	    					<select class="form-control" name="search_groupid" required>
	    						...
	    						<?php foreach($groupids as $value){?>
	    							<option <?php if($rule_gid == $value->groupid) echo "selected";?>><?= $value->groupid;?></option>
	    						<?php }?>
	    					</select>
	    				</div>
	    			</div>
	    			<div class="col-sm-3">
	    				<div class="form-group">
		                	...
		                	<input type="text" class="form-control" placeholder="Prefix" name="search_prefix" value="<?= $rule_prefix;?>" required>
	    				</div>
	    			</div>
	    			<div class="col-sm-3">
	    				<div class="form-group">
		                	...
		                	<select class="form-control" name="search_gwlist" >
	    						...
	    						<?php foreach($gwlists as $value){?>
	    							<option <?php if($rule_gwlist == $value->gwlist) echo "selected";?>><?= $value->gwlist;?></option>
	    						<?php }?>
	    					</select>
	    				</div>
	    			</div>
...
<div id="alert-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; top: 30%;">
	<div class="modal-dialog">
	    <div class="modal-content">
            ...
            <div class="modal-body p-4">
            	<h4>There are over 10,000 results</h4>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
            </div>
